...
public static class ScrollViewFocusFunctions
{
    ...
    public static Vector2 CalculateFocusedScrollPosition(this ScrollRect scrollView, RectTransform item, Vector2 offset)
    {
        ...
        return scrollView.CalculateFocusedScrollPosition(itemCenterPoint + contentSizeOffset + offset);
    }
    ...
    public static void FocusOnItem(this ScrollRect scrollView, RectTransform item, Vector2 offset)
    {
        scrollView.normalizedPosition = scrollView.CalculateFocusedScrollPosition(item, offset);
    }
    ...
    public static IEnumerator FocusOnItemCoroutine(this ScrollRect scrollView, RectTransform item, float speed, Vector2 offset)
    {
        yield return scrollView.LerpToScrollPositionCoroutine(scrollView.CalculateFocusedScrollPosition(item, offset), speed);
    }
}