            ...
            */
            ...
            Pass
            {
                ...
                half4 frag(v2f i) : COLOR
                {
                    ...
                    /*sum += GRABPIXEL(0.001, -4.0);
                    sum += GRABPIXEL(0.005, -3.5);
                    sum += GRABPIXEL(0.01, -3.0);
                    sum += GRABPIXEL(0.02, -2.5);
                    sum += GRABPIXEL(0.05, -2.0);
                    sum += GRABPIXEL(0.09, -1.5);
                    sum += GRABPIXEL(0.12, -1.0);
                    sum += GRABPIXEL(0.15, -0.5);
