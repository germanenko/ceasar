...
New UI System
--------------------
- Search FingersScript.cs for 'For new ui system' - then uncomment the few lines that follow.
- Then add to one of your scripts onenable method:
FingersScript.Instance.ComponentTypesToDenyPassThrough.Add(typeof(PanelRaycaster));
